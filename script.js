...
const STUDENTS = [
  { name:"Flutter Shy", work:"Year 2 Pop Up",     url:"https://flutter-shy-bit.github.io/Year2PopUp/", pos:{x:1021, y:434},  slot:{w:1021, h:434} },
  { name:"M Tyda",      work:"Unit 5",            url:"https://mtyda.github.io/unit5/",                 pos:{x:1100, y:619},  slot:{w:1100, h:619} },
  { name:"Val Ehu",     work:"Who Am I",          url:"https://valehu2517.github.io/WhoAmI/",           pos:{x:1274, y:715},  slot:{w:1274, h:715} },
  { name:"Mina",     work:"Title",          url:"https://minoliiih.github.io/unit5/",           pos:{x:1034, y:725},  slot:{w:1034, h:725} },
];
...
function buildCanvas(){
  ...
  STUDENTS.forEach(s=>{
    ...
    const sz = Math.round(min + Math.random()*(max-min)); // visual only
...
function buildMobileList(){
  ...
  mobileList.innerHTML = STUDENTS.map(s => `
...
window.addEventListener('resize', ()=>{ toggleMode(); matchPreview(); });
if (window.visualViewport) {
  window.visualViewport.addEventListener('resize', ()=>{ toggleMode(); matchPreview(); });
  window.visualViewport.addEventListener('scroll',  ()=>{ toggleMode(); matchPreview(); });
}
